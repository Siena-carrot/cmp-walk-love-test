const correctChoice = "c2";
const userAnswer = localStorage.getItem("obje7Answer");
...
function showMap(button) {
  try {
    ...
    // Only use the per-map description; do not fallback to the object's description
    let desc = '';
    if (section) {
    ...
    if (!filename) filename = 'obje7-map.jpg';
